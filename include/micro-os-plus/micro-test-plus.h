...
namespace micro_os_plus::micro_test_plus2
{
  ...
  //  * @param [in] name The name of the default test suite. Defaults to
  //  `"Main"`
  //  * if not specified.
  //  * @par Returns
  //  *  Nothing.
  ...
  //  *
  //  * @tparam Callable_T The type of the callable object to be executed as
  //  the
  //  * test case.
  //  * @tparam Args_T The types of the arguments to be passed to the callable.
  //  * @param [in] name The test case name or description, used in test
  //  reports.
