...
namespace micro_os_plus::micro_test_plus
{
  ...
  public:
     ...
     */
    virtual void
    begin_test_case (const char* name) = 0;
     ...
     */
    virtual void
    end_test_case (const char* name) = 0;
     ...
     */
    virtual void
    begin_test_suite (const char* name) = 0;
     ...
     */
    virtual void
    end_test_suite (test_suite_base& suite) = 0;
     ...
     */
    virtual void
    begin_test (size_t test_suites_count) = 0;
  ...
  protected:
     ...
     */
    virtual void
    output_pass_prefix_ (std::string& message) = 0;
    ...
    output_fail_prefix_ (std::string& message, const bool hasExpression,
                         const reflection::source_location& location) = 0;
