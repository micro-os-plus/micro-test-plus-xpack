...
#ifndef MICRO_TEST_PLUS_INLINES_TYPE_TRAITS_INLINES_H_
#define MICRO_TEST_PLUS_INLINES_TYPE_TRAITS_INLINES_H_
...
#endif // MICRO_TEST_PLUS_INLINES_TYPE_TRAITS_INLINES_H_
