...
template <typename T>
static void
test_case_expect_integrals_failed_combinations (subtest& t)
{
  t.expect (
  ...
  t.expect (ne (my_actual_integral<T> (),
                my_expected_integral<unsigned long long> ()))
      << "ne matches unsigned long long";
  local_counts.failed_checks++;

  t.expect (
      ne (my_actual_integral<T> (), my_expected_integral<signed long> ()))
  ...
  t.expect (ne (my_actual_integral<T> (), my_expected_integral<signed int> ()))
      << "ne matches signed int";
  local_counts.failed_checks++;

  t.expect (
      ne (my_actual_integral<T> (), my_expected_integral<unsigned int> ()))
      << "ne matches unsigned int";
  local_counts.failed_checks++;

  t.expect (
      ne (my_actual_integral<T> (), my_expected_integral<signed short> ()))
  ...
  t.expect (
      ne (my_actual_integral<T> (), my_expected_integral<signed char> ()))
  ...
  t.expect (gt (my_actual_integral<T> (), my_expected_integral<signed int> ()))
      << "gt matches signed int";
  local_counts.failed_checks++;

  t.expect (lt (my_actual_integral<T> (), my_expected_integral<signed int> ()))
  ...
  t.expect (
      gt (my_actual_integral<T> (), my_expected_integral<unsigned int> ()))
      << "gt matches unsigned int";
  local_counts.failed_checks++;

  t.expect (
      lt (my_actual_integral<T> (), my_expected_integral<unsigned int> ()))
      << "lt matches unsigned int";
  local_counts.failed_checks++;

  t.expect (eq (my_actual_integral_more<T> (),
                my_expected_integral<unsigned int> ()))
      << "eq matches unsigned int";
  local_counts.failed_checks++;

  t.expect (ge (my_actual_integral_less<T> (),
                my_expected_integral<unsigned int> ()))
      << "ge matches unsigned int";
  local_counts.failed_checks++;

  t.expect (le (my_actual_integral_more<T> (),
                my_expected_integral<unsigned int> ()))
...
static static_suite ts_integral_failed{ "Failed combinatorial integrals suite",
                                        tr, [] (auto& ts)
  {
    ...
    ts.test ("Combinatorial integrals with signed long long",
             test_case_expect_integrals_failed_combinations<signed long long>);
    ...
    ts.test (
        ...
        test_case_expect_integrals_failed_combinations<unsigned long long>);
    ...
    ts.test ("Combinatorial integrals with signed int",
             test_case_expect_integrals_failed_combinations<signed int>);
    ...
    ts.test ("Combinatorial integrals with unsigned int",
             test_case_expect_integrals_failed_combinations<unsigned int>);
    ...
    ts.test ("Combinatorial integrals with signed short",
             test_case_expect_integrals_failed_combinations<signed short>);
    ...
    ts.test ("Combinatorial integrals with unsigned short",
             test_case_expect_integrals_failed_combinations<unsigned short>);
    ...
    ts.test ("Combinatorial integrals with signed char",
             test_case_expect_integrals_failed_combinations<signed char>);
    ...
    ts.test ("Combinatorial integrals with unsigned char",
             test_case_expect_integrals_failed_combinations<unsigned char>);
