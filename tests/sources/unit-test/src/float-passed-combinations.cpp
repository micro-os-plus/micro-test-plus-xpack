...
template <typename T>
static void
test_case_expect_floats_passed_combinatorial (subtest& t)
{
  t.expect (
...
static static_suite ts_passed_floats{ "Combinatorial floats suite", tr,
                                      [] (auto& ts)
  {
    ...
    ts.test ("Combinatorial floats",
             test_case_expect_floats_passed_combinatorial<float>);
    ...
    ts.test ("Combinatorial doubles",
             test_case_expect_floats_passed_combinatorial<double>);
