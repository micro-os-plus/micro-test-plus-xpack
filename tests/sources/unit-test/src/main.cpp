...
static static_runner tr{ "Static top suite" };
  ...
  ts.test ("Integer comparisons", [] (auto& t)
    {
      ...
      t.expect (ne (my_actual_integral_more<int> (), 42)) << "actual+1 != 42";
      local_counts.successful_checks++;
  ...
  ts.test ("Failed integer comparisons", [] (auto& t)
    {
      ...
      t.expect (eq (my_actual_integral_more<int> (), 42)) << "actual+1 == 42";
      local_counts.failed_checks++;

      t.expect (ge (my_actual_integral_less<int> (), 42)) << "actual-1 >= 42";
      local_counts.failed_checks++;

      t.expect (gt (my_actual_integral (), 42)) << "actual > 42";
      local_counts.failed_checks++;

      t.expect (le (my_actual_integral_more<int> (), 42)) << "actual+1 <= 42";
      local_counts.failed_checks++;
  ...
  ts.test ("Float comparisons", [] (auto& t)
    {
...

      {
        ...
        t.expect (eq (111111.42f, 111111.42_f)) << "111111.42f == 111111.42_f";
        local_counts.successful_checks++;
  ...
  ts.test ("Failed float comparisons", [] (auto& t)
    {
...

      {
        ...
        t.expect (ne (111111.42f, 111111.42_f)) << "111111.42f == 111111.42_f";
        local_counts.failed_checks++;
  ...
  ts.test ("Logical operations", [] (auto& t)
    {
      ...
      t.expect (_not (eq (my_actual_integral (), 42))) << "not (actual == 42)";
      local_counts.failed_checks++;
...
template <typename T>
static void
test_case_expect_passed_integrals_combinatorial (subtest& t)
{
...
template <typename T>
static void
test_case_expect_failed_integrals_combinatorial (subtest& t)
{
