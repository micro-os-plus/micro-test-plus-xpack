...
# Unlike the sibling `-sdk` platforms, this platform links no Pico SDK CMake
# targets at all (no `pico_standard_link`), so there is no `bs2_default`/
# `bs2_default_library` boot-stage-2 target to prepend options to.
...
# the VS Code debug launcher (`.vscode/launch.json`) already uses for the
# sibling `raspberry-pi-pico-2-riscv-sdk` platform, which does have it.
