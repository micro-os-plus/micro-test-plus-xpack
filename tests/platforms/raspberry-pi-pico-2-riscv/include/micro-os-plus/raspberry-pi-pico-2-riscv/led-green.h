...
#ifndef MICRO_OS_PLUS_RASPBERRY_PI_PICO_2_RISCV_LED_GREEN_H_
#define MICRO_OS_PLUS_RASPBERRY_PI_PICO_2_RISCV_LED_GREEN_H_
...
namespace platform
{
  // Driver for the Raspberry Pi Pico 2 onboard green LED, wired to
  // GPIO25, active-high, with no series resistor other than the
  // RP2350 pad driver. Implemented directly on the RP2350 register
  // offsets (SIO, IO_BANK0, PADS_BANK0, RESETS), matching the
  // raw-register approach used by rp2350/system-clock.cpp; no Pico
...
#endif // MICRO_OS_PLUS_RASPBERRY_PI_PICO_2_RISCV_LED_GREEN_H_
