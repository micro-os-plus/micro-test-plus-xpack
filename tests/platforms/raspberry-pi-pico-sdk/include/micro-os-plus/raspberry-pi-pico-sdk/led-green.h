...
#ifndef MICRO_OS_PLUS_RASPBERRY_PI_PICO_SDK_LED_GREEN_H_
#define MICRO_OS_PLUS_RASPBERRY_PI_PICO_SDK_LED_GREEN_H_
...
namespace platform
{
  // Driver for the Raspberry Pi Pico onboard green LED
  // (`PICO_DEFAULT_LED_PIN`), implemented on top of the Pico SDK's own
  // `hardware_gpio` driver (`hardware/gpio.h`), unlike the sibling
  // raspberry-pi-pico platform, which drives the RP2040 CMSIS register
  // structs directly. This platform already links the Pico SDK proper
...
#endif // MICRO_OS_PLUS_RASPBERRY_PI_PICO_SDK_LED_GREEN_H_
