...
// for XOSC_HZ==12 MHz && SYS_CLK_HZ==125 MHz).
//
...
// configured; clk_usb/clk_adc/clk_rtc and the tick generators are not
// used by this platform and are left at their reset state.
