...
const config: Config = {
  ...
  tagline: 'A lightweight, macro-free C++ testing framework for embedded projects, with TAP output',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/micro-os-plus/micro-test-plus-xpack/',
          position: 'right',
        ...
        },
        {
          ...
          items: [
            {
              label: `micro-test-plus-xpack project`,
              href: `https://github.com/micro-os-plus/micro-test-plus-xpack/`,
            },
            {
        ...
        },
        {
          ...
          position: 'right',
          href: `https://www.npmjs.com/package/@micro-os-plus/micro-test-plus/v/${customFields.releaseVersion}`,
        },
      ],
    },
    footer: {
      ...
      links: [
          ...
          items: [
            {
              ...
              href: 'https://github.com/micro-os-plus/micro-test-plus-xpack/discussions',
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub micro-test-plus-xpack project',
              href: 'https://github.com/micro-os-plus/micro-test-plus-xpack/',
            },
            {
