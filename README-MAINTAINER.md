...
- name the post like: **µOS++ µTest++ v1.1.1 released**
...
- `npm dist-tag add @micro-os-plus/micro-test-plus@1.1.1 latest`
- `npm dist-tag ls @@micro-os-plus/micro-test-plus`
...
- paste the release name like **µOS++ µTest++ v1.1.1 released**
